...
public class MyActivity extends Activity {
	...
	private RelativeLayout rel_travel_report, rel_my_order,
	...
	private void RequestData() {
		...
		new HttpTask(myCallback, MyURL.MY,MyActivity.this).execute(idtakjson);
	...
	private HttpCallback myCallback = new HttpCallback() {
		...
		public void getResult(JSONObject json) {
			...
			if (entity.isFlag()) {
				...
				x.image().bind(img_carlogo,car.getBrand_logo());
				...
				if (entity.getMessage() == MyURL.MSG_OTHERS_ERROR) {
					...
					// 重启app
					MainActivity.restartApplication(MyActivity.this);
				}
			}
	...
	private void setListen() {
		...
		but_my_red_paper.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if ((Boolean) SPUtils
						.get(MyActivity.this, "isBoxbind", false)) {
				Intent intent = new Intent(MyActivity.this,
						MyRedPaprerActivity.class);
				startActivity(intent);
				} else {
					MainActivity.dialogredmain(MyActivity.this);
				}
			}
		});
