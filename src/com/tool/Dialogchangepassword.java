...
public class Dialogchangepassword extends Dialog{
	...
	private void setCustomDialog() {
		View mView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_changepassword, null);
		editText1 = (EditText) mView.findViewById(R.id.edt_one);
		editText2 = (EditText) mView.findViewById(R.id.edt_two);
		editText3 = (EditText) mView.findViewById(R.id.edt_three);
