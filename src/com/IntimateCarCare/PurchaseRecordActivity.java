...
public class PurchaseRecordActivity extends Activity{
	...
	private void ReastDate() {
		...
		new HttpTask(getpurchasecallback, MyURL.BUYRECORD,PurchaseRecordActivity.this).execute(update);
	}
   ...
   &&purchasefiles.getDate().equals("")){
	...
	private void setListen() {
		...
		img_commit.setOnClickListener(new OnClickListener() {
			...
			new HttpTask(purchasecallback, MyURL.CHANGERECORD,PurchaseRecordActivity.this).execute(update);
			}
		});
	}
