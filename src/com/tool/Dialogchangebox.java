...
public class Dialogchangebox extends Dialog{

	private EditText editText1 ,editText2, editText3;
	private TextView cancelButton, sureButton;
	public Dialogchangebox(Context context) {
	...
	private void setCustomDialog() {
		View mView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_changebox, null);
