...
public class YearInspection extends Activity{
	...
	private void RequestData() {
		// TODO Auto-generated method stub
	    HashMap<String, String> getinsurancedate = new UserEntity().getIdTaken(YearInspection.this);
	  
		new HttpTask(myyearinspectionCallback, MyURL.ALLYEARINSPECT,YearInspection.this).execute(getinsurancedate);
	}
